...
CONFIG = {
    ...
    "paths": {
        "ckpt": "/mnt/users/fernando.tonucci/contrastive-learning/ae_res/slakh/slakh_best.pt",
        "save_dir": "../res/slakh_ae_weak_new",
    },
    ...
    "losses": {
        ...
        "residual_loss_kwargs": {
            "losses": [losses.HSIC_RBF_Multi()]
        },

        "coverage_loss_fn": losses.NormMSE,
        "coverage_loss_kwargs": {},

        "decomp_loss_fn": losses.NormMSE,
        "decomp_loss_kwargs": {},
